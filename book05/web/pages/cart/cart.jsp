        ...
        $(function () {
            ...
            $(".updateClass").change(function () {
                ...
                if (confirm("你确定要将【" + name + "】数量修改为" + count + "?")) {
                    location.href = "${basePath}cart/updateCount?id=" + bookId + "&count=" + count;
                } else {
...
<div id="main">
    <table>
        ...
        <c:forEach items="${sessionScope.cart.items}" var="entry">
            <tr>
                ...
                <td><a class="deleteClass" href="cart/deleteItem?id=${entry.value.id}">删除</a></td>
            </tr>
        </c:forEach>
    ...
    <c:if test="${not empty sessionScope.cart.items}">
        <div class="cart_info">
            ...
            <span class="cart_span"><a href="client/createOrder">去结账</a></span>
        </div>
    </c:if>
</div>
